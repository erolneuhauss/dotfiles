...
lvim.keys.normal_mode["<C-d>"] = ":LspStop<cr>"
lvim.builtin.which_key.mappings["d"] = { "<cmd>LspStop<cr>", "Stop LSP" }
...
-- Additional Plugins
lvim.plugins = {
  {"tpope/vim-fugitive"},                   -- provides commands like :Gw
  ...
  },  -- vertical lines per indention
  {
    "folke/trouble.nvim",       -- A pretty list for showing diagnostics and more
    cmd = "TroubleToggle",
  },
  {
    "windwp/nvim-spectre",
