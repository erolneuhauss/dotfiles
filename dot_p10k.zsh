# Generated by Powerlevel10k configuration wizard on 2021-03-22 at 21:39 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    my_cpu_temp           # fetch current CPU temperature
    load                  # CPU load
  ...
  function prompt_my_cpu_temp() {
    ...
    if (( cpu_temp >= 80 )); then
      p10k segment -f red -i '' -t "${cpu_temp}°C"
    elif (( cpu_temp >= 60 )); then
      p10k segment -f yellow -i '' -t "${cpu_temp}°C"
    elif (( cpu_temp >= 50 )); then
      p10k segment -f green -i '' -t "${cpu_temp}°C"
    elif (( cpu_temp < 50 )); then
      p10k segment -f blue -i '' -t "${cpu_temp}°C"
    fi
  }
